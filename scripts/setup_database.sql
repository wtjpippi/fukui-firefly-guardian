...
CREATE TABLE firefly_points (
  ...
  status TEXT NOT NULL DEFAULT 'low' CHECK (status IN ('high', 'medium', 'low')),
  description TEXT,
...
INSERT INTO firefly_points (id, name, course, lat, lng, status, description, updated_at) VALUES
  ('point-hotaru-1', '蛍観橋コース', '蛍観橋コース', 37.760707, 138.832346, 'high', '水辺沿いに多数飛翔中', '2026-04-01T20:30:00+09:00'),
  ('point-donokoshi-1', '堂ノ腰コース　林道出口', '堂ノ腰コース', 37.756259, 138.834314, 'high', '今年一番の飛翔スポット', '2026-04-01T19:28:00+09:00'),
  ...
  ('point-donokoshi-4', '堂ノ腰コース　遊歩道', '堂ノ腰コース', 37.757668, 138.831283, 'medium', '草むらに隠れて光っています', '2026-04-01T19:10:00+09:00'),
...
INSERT INTO parking_lots (id, name, lat, lng, capacity, walk_time, status, hint, updated_at) VALUES
  ...
  ('P3', '農村改善センター裏', 37.759504, 138.827936, 20, '徒歩5分', 'normal', 'P1~P2が満車の場合にまず狙いたい場所です。', '2025-06-21T18:00:00+09:00'),
  ('P4', '角田山登山口（国道側）', 37.758811, 138.833730, 20, '徒歩5分', 'normal', '国道側で出入りしやすい中規模駐車場です。', '2025-06-21T18:15:00+09:00'),
  ('P5', '角田山登山口（登山口側）', 37.758849, 138.834373, 20, '徒歩5分', 'normal', '登山口に近く、P4と合わせて利用されます。', '2025-06-21T18:00:00+09:00'),
  ('P6', '旧庄屋佐藤家', 37.754993, 138.837549, 30, '徒歩20分', 'normal', '大規模で停めやすい穴場。散策を兼ねてどうぞ。', '2025-06-21T17:30:00+09:00'),
  ('P7', '福井神社前', 37.753248, 138.836342, 10, '徒歩20分', 'normal', '少し離れますが、比較的空車が多いです。', '2025-06-21T17:30:00+09:00'),
  ('P8', '福井集落開発センター', 37.754418, 138.839829, 10, '徒歩25分', 'normal', '最も遠いですが、混雑時でも停めやすい場所です。', '2025-06-21T17:30:00+09:00');
